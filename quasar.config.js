...
module.exports = configure(function (ctx) {
  return {
    ...
    // https://v2.quasar.dev/quasar-cli-vite/quasar-config-js#Property%3A-ssr
    ssr: {
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'quasar-login-app'
      }
    },

    // Full list of options: https://v2.quasar.dev/quasar-cli-vite/quasar-config-js#Property%3A-bex
    bex: {
      contentScripts: [
        'my-content-script'
      ],
